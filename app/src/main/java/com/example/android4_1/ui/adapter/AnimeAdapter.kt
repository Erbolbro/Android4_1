package com.example.android4_1.ui.adapter
...
import com.example.android4_1.databinding.ItemAnimeBinding
...
class AnimeAdapter : ListAdapter<Anime, AnimeAdapter.AnimeViewHolder>(animeDiffUtil) {
    ...
    inner class AnimeViewHolder(val binding: ItemAnimeBinding) : ViewHolder(binding.root) {
